...
| Состояние | Активная разработка; текущая версия 0.14.0 | Экспериментальный локальный прототип |
...
- YouTube-плейлисты: выбор видео по обложке, отметки и пакетная загрузка до 10 выбранных пунктов за запуск; для музыки выбирается M4A или MP3.
